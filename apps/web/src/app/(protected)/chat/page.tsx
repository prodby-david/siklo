      ...
      >
        <div className="max-w-4xl mx-auto flex items-center gap-2 bg-muted/50 rounded-2xl p-1.5 border border-neutral-border focus-within:border-brand-accent focus-within:ring-2 focus-within:ring-brand-accent/20 transition-all duration-200">
          ...
          <button
            ...
            className="flex shrink-0 cursor-pointer items-center justify-center rounded-xl bg-brand-accent p-2 text-brand-accent-foreground transition-all duration-200 hover:bg-brand-accent-hover active:scale-95 disabled:opacity-50 disabled:hover:bg-brand-accent"
          >
