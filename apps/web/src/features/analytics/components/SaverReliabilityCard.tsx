...
export default function SaverReliabilityCard({
  ...
  return (
    <div className="p-5 sm:p-6 border border-neutral-border rounded-3xl bg-card shadow-xs space-y-4 hover:border-neutral-border/90 transition-all flex flex-col justify-between">
      ...
      <div className="grid grid-cols-2 gap-3 pt-2">
        <div className="p-3 rounded-2xl border border-neutral-border/70 bg-neutral-table-stripe/30 flex items-center gap-3">
          ...
          <div>
            <span className="text-[10px] font-bold text-neutral-subtext block uppercase tracking-wider">
              Active Cycles
            </span>
