...
import CycleTurnShowcase from "./CycleTurnShowcase";
import SmartLedgerGuarantee from "./SmartLedgerGuarantee";

export default function RotationSystemSection() {
  return (
    <section className="w-full bg-transparent relative z-10 border-y border-brand-accent/20 py-16 sm:py-24 flex flex-col gap-10 sm:gap-14 transition-colors duration-300">
      <motion.div
      ...
      >
        ...
        <p className="text-xs sm:text-sm text-neutral-subtext leading-relaxed font-normal max-w-xl">
          Track every payout turn, contribution progress, and payout lump
          sum in real-time with full group transparency.
        </p>
      </motion.div>
