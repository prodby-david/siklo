...
export const HeroStatsWidget = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 w-full">
      <div className="relative group rounded-3xl border border-neutral-border/80 bg-card/80 backdrop-blur-xl p-4 sm:p-5 transition-all duration-300 hover:border-brand-accent/50">
