...
export default function GroupHeroWisdomQuoteCard() {
  return (
    <div className="flex flex-col gap-2 bg-card/80 backdrop-blur-sm border border-neutral-border p-4 rounded-2xl w-full sm:min-w-[260px] sm:max-w-xs shadow-sm">
