...
export default function BestPracticeItem({ practice }: BestPracticeItemProps) {
  return (
    <div className="p-5 rounded-2xl border border-brand-accent/25 bg-card/80 backdrop-blur-xl flex flex-col gap-2 hover:border-brand-accent/50 transition-all duration-300 shadow-xs">
