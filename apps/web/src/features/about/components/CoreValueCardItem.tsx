...
export default function CoreValueCardItem({ item }: CoreValueCardItemProps) {
  ...
  return (
    <div className="flex flex-col gap-4 p-6 sm:p-7 rounded-3xl border border-brand-accent/25 bg-card/80 backdrop-blur-xl relative z-10 hover:border-brand-accent/50 transition-all duration-300 shadow-xs">
