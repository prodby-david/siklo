...
export default function TrustCardItem({ item }: TrustCardItemProps) {
  return (
    <div className="h-full p-6 rounded-3xl border border-brand-accent/25 bg-card/80 backdrop-blur-xl flex flex-col justify-between gap-4 hover:border-brand-accent/50 transition-all duration-300 shadow-xs">
