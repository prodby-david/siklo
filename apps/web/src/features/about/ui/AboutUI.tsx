...
export default function AboutUI() {
  return (
    <>
      ...
      <section
        id="core-pillars"
        className="w-full bg-transparent relative z-10 border-y border-brand-accent/20 py-16 sm:py-24 transition-colors duration-300 scroll-mt-24"
      >
      ...
      <section
        id="terms-guide"
        className="w-full bg-transparent relative z-10 py-16 sm:py-24 border-b border-brand-accent/20 transition-colors duration-300 scroll-mt-24"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <PaluwaganTermsGuide />
        </div>
      ...
      <section
        id="transparency"
        className="w-full bg-transparent relative z-10 py-16 sm:py-24 border-b border-brand-accent/20 scroll-mt-24"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <TrustCards />
        </div>
