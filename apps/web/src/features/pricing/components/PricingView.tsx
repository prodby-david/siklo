  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden py-16 md:py-24 border-b border-neutral-border/60 bg-transparent z-10">
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.5, ease: "easeOut" }}
            className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center space-y-4"
          >
            ...
            <motion.h1
              ...
              className="text-3xl md:text-5xl font-black tracking-tight text-foreground max-w-3xl mx-auto leading-tight"
            >
            ...
            <motion.p
              ...
              className="text-sm md:text-base text-neutral-subtext max-w-xl mx-auto leading-relaxed"
            >
        ...
        <section className="py-16 md:py-24 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
            {PRICING_PLANS.map((plan, index) => (
              <PricingCard key={plan.id} plan={plan} interval={interval} index={index} />
            ))}
          </div>
        </section>
